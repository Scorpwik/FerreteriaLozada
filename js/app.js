...
onSnapshot(productosRef, snapshot => {
  ...
  snapshot.forEach(d => {
    ...
    catalogData.push({ id: d.id, ...data, category: cleanCat });
    if (cleanCat && !dynamicCategories.includes(cleanCat))
      dynamicCategories.push(cleanCat);
  });
